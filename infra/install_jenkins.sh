...
su - jenkins -c "echo \"export SECRETDEVOPS=$DEVOPSPWD\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export ANS=$ANSIBPASS\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export KEYNAME=$KEYNAME1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export TYPENAME=$TYPENAME1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export REGION=$REGION1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export AWS_ACCESS_KEY=$AAKI1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export AWS_SECRET_KEY=$ASAKI1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPUB=$SUBIDPUB1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPRIV=$SUBIDPRIV1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPUBADM=$SUBIDPUBADM1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPRIVADM=$SUBIDPRIVADM1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPUBDEV=$SUBIDPUBDEV1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPRIVDEV=$SUBIDPRIVDEV1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPUBQUA=$SUBIDPUBQUA1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPRIVQUA=$SUBIDPRIVQUA1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPUBPROD=$SUBIDPUBPROD1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SUBIDPRIVPROD=$SUBIDPRIVPROD1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export VPCID=$VPCID1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export PRIVIP=$PRIVIP1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export INGRPORT=$INGRPORT1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SECGRPNLST=$SECGRPNLST1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export USCRIPT=$USCRIPT1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export SECGRPID=$SECGRPID1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
su - jenkins -c "echo \"export INSTTYPE=$INSTTYPE1\" >> /var/lib/jenkins/.envvars/stacktest-staging.groovy"
